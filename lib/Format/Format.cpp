...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    IO.mapOptional("AlignTokenMaxPadding", Style.AlignTokenMaxPadding);
    ...
    IO.mapOptional("NestedMacroIndent", Style.NestedMacroIndent);
    ...
    IO.mapOptional("PenaltyBreakOnLogicalOperators", Style.PenaltyBreakOnLogicalOperators);
...
template <> struct MappingTraits<FormatStyle::BraceWrappingFlags> {
  static void mapping(IO &IO, FormatStyle::BraceWrappingFlags &Wrapping) {
    ...
    IO.mapOptional("BeforeCaseBreak", Wrapping.BeforeCaseBreak);
...
static FormatStyle expandPresets(const FormatStyle &Style) {
  ...
  const bool DefaultCaseBreak = true;
  Expanded.BraceWrapping = {false, false, false, false, false, false,
                            false, false, false, false, DefaultCaseBreak, false};
...
FormatStyle getLLVMStyle() {
  ...
  LLVMStyle.AlignTokenMaxPadding = 0;
  ...
  LLVMStyle.PenaltyBreakOnLogicalOperators = 0;
